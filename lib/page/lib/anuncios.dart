...
class Anuncions extends StatefulWidget {
  const Anuncions({Key? key}) : super(key: key);

  @override
  State<Anuncions> createState() => _AnuncionsState();
}

class _AnuncionsState extends State<Anuncions> {
  @override
        ...
        child: Column(
          children: [
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: Row(
                                    mainAxisAlignment: MainAxisAlignment.end,
                                    children: [
                                      Text("Criado a 12 de Março, 2022",style: TextStyle(
                                        fontWeight: FontWeight.normal,
                                        fontSize: 10,
                                        fontFamily: 'Rubik',
                                        color: Theme.of(context).accentColor,
                                ...
                                Padding(
                                  padding: const EdgeInsets.fromLTRB(160, 57, 0, 0),
                                  child: Row(
                                    mainAxisAlignment: MainAxisAlignment.center,
                                    children: [
                                      InkWell(
                                        child: SvgPicture.asset("assets/editarBTN.svg",
                                            height: 20),
                                        onTap: (){
            ...
            Row(
              ...
              children: [
                InkWell(
                  child:SvgPicture.asset("assets/adicionarbtn.svg"),
                  onTap: () {
