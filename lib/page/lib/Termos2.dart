...
class Termos2 extends StatefulWidget {
  const Termos2({Key? key}) : super(key: key);

  @override
  State<Termos2> createState() => _Termos2State();
}

class _Termos2State extends State<Termos2> {
